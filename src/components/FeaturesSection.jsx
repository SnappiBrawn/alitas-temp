    ...
    <section id="featuresSection" className="lg:my-40 my-20 flex flex-col justify-center items-center gap-20 md:gap-40 font-[SF-Pro-Display]">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 text-left">
        <div className="lg:w-1/2">
          ...
          <p className="text-sm/6 lg:text-base/7 mt-6 text-gray-500 max-w-xl px-4 lg:px-0">
      ...
      <div className="flex flex-col lg:flex-row-reverse items-center justify-between gap-10 text-right lg:text-left">
        <div className="lg:w-1/2">
          <p className="text-(--color-section-heading) lg:text-sm text-xs font-bold uppercase mb-5 px-4 lg:px-0">
          ...
          <p className="text-sm/6 lg:text-base/7 mt-6 text-gray-500 max-w-xl text-right lg:text-left px-4 lg:px-0">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 text-center lg:text-left">
        <div className="lg:w-1/2">
          ...
          <p className="text-sm/6 lg:text-base/7 mt-6 text-gray-500 max-w-xl text-justify px-4 lg:px-0">
